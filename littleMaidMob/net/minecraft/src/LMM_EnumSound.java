...
public enum LMM_EnumSound {
	...
	death(0x100, "Deid Voice. Null is no Voice", "mob.ghast.death"),
	attack(0x110, "Attack Voice. Null is no Voice", "mob.ghast.charge"),
	attack_bloodsuck(0x111, "Attack Bloodsucker Voice. Null is no Voice", "^"),
	laughter(0x120, "Laughter Voice. Null is no Voice", ""),
	shoot(0x130, "shoot Voice. Null is no Voice", "mob.ghast.charge"),
	shoot_burst(0x131, "burst shoot Voice. Null is no Voice", "mob.ghast.charge"),
...
//	eatGunpowder(0x161, "Eat Gunpowder Voice. Null is no Voice", "^"),
	...
	hurt(0x300, "Dameged Voice. Null is no Voice", "mob.ghast.scream"),
	hurt_snow(0x301, "Dameged Voice from snowball. Null is no Voice", ""),
	hurt_fire(0x302, "Dameged Voice from fire. Null is no Voice", ""),
	hurt_guard(0x303, "Dameged Voice on Guard. Null is no Voice", "mob.blaze.hit"),
	hurt_fall(0x304, "Dameged Voice from Fall. Null is no Voice", ""),
	hurt_nodamege(0x309, "No Dameged Voice. Null is no Voice", "mob.blaze.hit"),
	...
	living_daytime(0x500, "Living Voice(Default) in Daytime. Null is no Voice", "mob.ghast.moan"),
	...
	goodmorning(0x551, "Goodmorning Voice. Null is no Voice", "mob.wolf.bark"),
	goodnight(0x561, "Goodnight Voice. Null is no Voice", "mob.ghast.affectionate scream"),
